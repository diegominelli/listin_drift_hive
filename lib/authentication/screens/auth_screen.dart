...
import 'package:listin_drift_hive/_core/constants/listin_colors.dart';
import 'package:listin_drift_hive/authentication/screens/widgets/show_custom_snackbar.dart';
import 'package:listin_drift_hive/authentication/services/auth_service.dart';
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  esqueciMinhaSenhaClicado() {
    ...
    showDialog(
      context: context,
      builder: (context) {
        TextEditingController redefincaoSenhaController = TextEditingController(
          text: email,
        );
        return AlertDialog(
